exports.info = (id, zyrexbot, corohelp, tampilTanggal, tampilWaktu, instagram, telegram, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `⚜ ${zyrexbot} ⚜
...
INFO BOT! :
🔱 *AUTHOR*: zyrex
🔱 *GITHUB*: https://github.com/Zyrexbot/zyrexbotwa
🔱 *INSTAGRAM*: ${zyrex.official_}
🔱 *YOUTUBE*: ${zyrex gmg}
🔱 *TELEGRAM* : ${zyrex}
🔱 *WHATSAPP* : 081358102778
